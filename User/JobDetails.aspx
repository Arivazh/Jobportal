...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main>
        ...
        <div class="job-post-company pt-120 pb-120">
            <div class="container">
                <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand1" OnItemDataBound="DataList1_ItemDataBound1">
                    <ItemTemplate>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                         ...
                         <div class="apply-btn2">
                            <%--<a href="#" class="btn"></a>--%>
                             <asp:LinkButton ID="lbApplyJob" runat="server" CssClass="btn" Text="Apply Now" CommandName="ApplyJob">Apply Now</asp:LinkButton>
                         </div>
                       </div>

           ...
           <%-- <div>
            ...
            <div class="btn-toolbar justify-content-between mb-3">
                ...
                <div class ="input-group h-25">
                    <asp:HyperLink ID="LinkBack" runat="server" NavigateUrl="~/Admin/JobList.aspx" CssClass="btn-secondary"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtJobTitle" style="font-weight: 600">Qualification/Education rquired</label>
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. Web MCA,Btech,MBA" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtExperience" style="font-weight: 600">Experience Required</label>
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="2Years,1.5 Years" required>
                    </asp:TextBox>
                </div>
            </div>
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSpecializatiom" runat="server" CssClass="form-control" placeholder="Enter Specialization"
                        TextMode="MultiLine" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtLastDate" style="font-weight: 600">Last Date To Apply</label>
                    <asp:TextBox ID="txtLastDate" runat="server" CssClass="form-control" placeholder="Enter Last Date"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Ex:Organization Name" required>
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtWebsite" runat="server" CssClass="form-control" placeholder="Enter Website" required
                        TextMode="Url">
                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
